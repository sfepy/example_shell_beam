...
project = u'sfepy_example_shell_beam'
copyright = u'2023, Vladimír Lukeš'
author = u'Vladimír Lukeš'
...
html_context = {
    ...
    'github_user': 'vlukes',
    'github_repo': 'example_shell_beam',
    'menu_links_name': 'Connections',
    'menu_links': [
        ('<i class="fa fa-github fa-fw"></i> Source Code', 'https://github.com/sfepy/example_shell_beam'),
...
htmlhelp_basename = 'example_shell_beam'
